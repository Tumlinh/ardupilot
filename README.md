...
This fork is focused on integrating ArduPilot with a specific Gazebo environment simulating UAVs. In particular, the UAVs are equipped with a rangefinder.  
